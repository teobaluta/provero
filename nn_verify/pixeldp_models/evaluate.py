...
import datasets
import numpy as np
import pixeldp_models.params
from pixeldp_models import pixeldp_cnn, pixeldp_resnet
...
def evaluate(hps, model, dataset=None, dir_name=None, rerun=False,
    ...
    with tf.device(dev):
        ...
        dir_name = os.path.join(dir_name, pixeldp_models.params.name_from_params(model, hps))
        ...
        #try:
        #    print('Loading from {}'.format(dir_name))
